...
public class ClientSideServiceActivity extends Activity implements View.OnClickListener{

        private static final String TAG=ClientSideServiceActivity.class.getSimpleName();
