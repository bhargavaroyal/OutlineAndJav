package com.bhargavaroyal.outlineandjav.Service.JobIntentService;
...
public class JobIntentServiceActivity extends Activity implements View.OnClickListener {
    ...
    private static final String TAG = JobIntentServiceActivity.class.getSimpleName();

    private Button buttonStart, buttonStop;
    private TextView textViewthreadCount;
    int count = 0;

    private BasicJobIntentService myService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceIntent=new Intent(getApplicationContext(),BasicJobIntentService.class);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.buttonThreadStarter:
                BasicJobIntentService.enqueueWork(this,serviceIntent);
                break;
