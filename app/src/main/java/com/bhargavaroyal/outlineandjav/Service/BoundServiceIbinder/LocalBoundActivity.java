package com.bhargavaroyal.outlineandjav.Service.BoundServiceIbinder;
...
public class LocalBoundActivity extends Activity  implements View.OnClickListener {

    private static final String TAG = LocalBoundActivity.class.getSimpleName();
    ...
    private LocalBoundService myService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceIntent=new Intent(getApplicationContext(), LocalBoundService.class);
        ...
        if(serviceConnection==null){
            serviceConnection=new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                    LocalBoundService.MyServiceBinder myServiceBinder=(LocalBoundService.MyServiceBinder)iBinder;
