package com.bhargavaroyal.outlineandjav.AndroidPatternArchitecture.mvvm;
...
public class mvvmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // via the ViewModel
//        ActivityMainBinding activityMainBinding = DataBindingUtil.setContentView(this, R.layout.activity_mvvm);
