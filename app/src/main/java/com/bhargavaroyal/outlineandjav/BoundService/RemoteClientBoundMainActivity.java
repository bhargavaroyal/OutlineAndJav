package com.bhargavaroyal.outlineandjav.BoundService;
...
public class RemoteClientBoundMainActivity /*extends AppCompatActivity implements View.OnClickListener */{
/*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceIntent.setComponent(new ComponentName
                ("com.bhargavaroyal.myapplication",
                        "com.bhargavaroyal.myapplication.MyService"));
