package com.bhargavaroyal.javalib.multithreading.javaConcurrent;
...
public class SemaPhoreMethods {
    public static void main(String args[]) throws InterruptedException {
        ...
        MyThreadSemaphore mt1 = new MyThreadSemaphore(sem, "A");
        MyThreadSemaphore mt2 = new MyThreadSemaphore(sem, "B");
 ...
 class MyThreadSemaphore extends Thread {
    ...
    public MyThreadSemaphore(Semaphore sem, String threadName) {
        super(threadName);
        this.sem = sem;
